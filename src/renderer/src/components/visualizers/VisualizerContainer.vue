...
import { ref } from 'vue'
import { Radio, BarChart3, Disc, Sparkles, SlidersHorizontal } from 'lucide-vue-next'
...
<template>
  <div class="w-full max-w-2xl bg-lofi-surface/80 border border-lofi-border/80 rounded-2xl p-6 backdrop-blur-md shadow-2xl flex flex-col items-center">
    <!-- Visualizer Mode Tabs -->
    <div class="w-full flex items-center justify-between mb-4 pb-3 border-b border-lofi-border/50">
    ...
    <div
      v-if="showControls"
      class="w-full mb-4 px-4 py-2.5 bg-lofi-card/50 rounded-xl border border-lofi-border/50 flex items-center justify-between text-xs"
    >
    ...
    <div class="w-full h-64 bg-lofi-bg/60 rounded-xl border border-lofi-border/60 flex items-center justify-center overflow-hidden relative">
      <AnalogVuMeter
